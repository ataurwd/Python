...
#example 1:1 passing arguments by a function
def calculate_price(apple = 300, mango = 100, banana = 20):
    return apple + mango + banana;

print(f"Total Price = {calculate_price( apple=500, mango=50, banana=50)}")
